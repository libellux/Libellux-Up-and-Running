...
sudo cp -rv $INSTALL_DIR/* / && \\
rm -rf $INSTALL_DIR/*
`)])])],-1),Ue=e("div",{class:"language-shell-session","data-ext":"shell-session","data-title":"shell-session"},[e("pre",{class:"language-shell-session"},[e("code",null,[e("span",{class:"token output"},`tar -C $SOURCE_DIR -xvzf $SOURCE_DIR/gsad-$GSAD_VERSION.tar.gz && \\
mkdir -p $BUILD_DIR/gsad && cd $BUILD_DIR/gsad && \\
cmake $SOURCE_DIR/gsad-$GSAD_VERSION \\
  -DCMAKE_INSTALL_PREFIX=$INSTALL_PREFIX \\
  -DCMAKE_BUILD_TYPE=Release \\
...
sudo chmod 6750 /usr/local/sbin/gvmd
`)])])],-1),Us=e("p",null,"Feed validation.",-1),xs=e("div",{class:"language-shell-session","data-ext":"shell-session","data-title":"shell-session"},[e("pre",{class:"language-shell-session"},[e("code",null,[e("span",{class:"token output"},`export GNUPGHOME=/tmp/openvas-gnupg && \\
mkdir -p $GNUPGHOME && \\
gpg --import /tmp/GBCommunitySigningKey.asc && \\
...
WantedBy=multi-user.target
EOF
`)])])],-1),Ln=e("p",null,"Copy the startup script to your system's manager directory.",-1),Un=e("div",{class:"language-shell-session","data-ext":"shell-session","data-title":"shell-session"},[e("pre",{class:"language-shell-session"},[e("code",null,[e("span",{class:"token output"},`sudo cp $BUILD_DIR/notus-scanner.service /etc/systemd/system/
...
`)])]),e("div",{class:"highlight-lines"},[e("div",{class:"highlight-line"}," "),e("br")])],-1),Gt=i(`<p>Update the SELinux configuration file and set SELINUX to disabled.</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># This file controls the state of SELinux on the system.</span>
