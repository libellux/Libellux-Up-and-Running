import{_ as i,r,o as l,c,a as e,d as t,b as a,e as s}from"./app-9bd5f875.js";const d={},p=e("h1",{id:"graylog-centralized-log-management",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#graylog-centralized-log-management","aria-hidden":"true"},"#"),t(" Graylog Centralized Log Management")],-1),u=e("p",null,"Graylog is a leading centralized log management solution built to open standards for capturing, storing, and enabling real-time analysis of terabytes of machine data.",-1),g={href:"https://www.graylog.org/",target:"_blank",rel:"noopener noreferrer"},h={href:"https://github.com/Graylog2/graylog2-server",target:"_blank",rel:"noopener noreferrer"},m=e("p",null,"Setup and configuration has been tested on following OS with version:",-1),y=e("ul",null,[e("li",null,"Ubuntu- 16.04, 20.04 (Focal Fossa), VMware ESXi 6.7.0"),e("li",null,"Graylog- 3.0, 3.3.4, 3.3.4-1 (Virtual Appliance)")],-1),f={href:"https://ko-fi.com/B0B31BJU3",target:"_blank",rel:"noopener noreferrer"},v=e("img",{src:"https://www.ko-fi.com/img/githubbutton_sm.svg",alt:"ko-fi"},null,-1),b=s(`<h2 id="configuration-files" tabindex="-1"><a class="header-anchor" href="#configuration-files" aria-hidden="true">#</a> Configuration files</h2><h2 id="prerequisites" tabindex="-1"><a class="header-anchor" href="#prerequisites" aria-hidden="true">#</a> Prerequisites</h2><ul><li><code>mongodb</code></li><li><code>apt-transport-https</code></li><li><code>openjdk-8-jre-headless</code></li><li><code>uuid-runtime</code></li><li><code>pwgen</code></li></ul><h2 id="virtual-appliance-installation" tabindex="-1"><a class="header-anchor" href="#virtual-appliance-installation" aria-hidden="true">#</a> Virtual Appliance installation</h2><h3 id="minimum-requirements" tabindex="-1"><a class="header-anchor" href="#minimum-requirements" aria-hidden="true">#</a> Minimum requirements</h3><ul><li>2 CPU</li><li>4096 MB memory</li><li>20 GB storage</li></ul><h2 id="setup-graylog" tabindex="-1"><a class="header-anchor" href="#setup-graylog" aria-hidden="true">#</a> Setup Graylog</h2><p>First download and install all dependencies.</p><pre><code>$ sudo apt-get install apt-transport-https openjdk-8-jre-headless uuid-runtime pwgen
</code></pre><h2 id="mongodb" tabindex="-1"><a class="header-anchor" href="#mongodb" aria-hidden="true">#</a> MongoDB</h2><pre><code>$Â sudo apt-key adv --keyserver hkp://keyserver.ubuntu.com:80 --recv 9DA31620334BD75D9DCB49F368818C72E52529D4
...
</code></pre><h2 id="graylog-behind-nginx-proxy" tabindex="-1"><a class="header-anchor" href="#graylog-behind-nginx-proxy" aria-hidden="true">#</a> Graylog behind NGINX proxy</h2><div class="language-nginx line-numbers-mode" data-ext="nginx"><pre class="language-nginx"><code><span class="token directive"><span class="token keyword">server</span></span> <span class="token punctuation">{</span>
...
</code></pre><h3 id="encrypt-rsyslog-with-ssl-tls" tabindex="-1"><a class="header-anchor" href="#encrypt-rsyslog-with-ssl-tls" aria-hidden="true">#</a> Encrypt rsyslog with SSL/TLS</h3>`,10),_={href:"https://www.rsyslog.com/doc/v8-stable/tutorials/tls_cert_summary.html",target:"_blank",rel:"noopener noreferrer"},S=s(`<h3 id="create-private-key-and-self-signed-ca-certificate" tabindex="-1"><a class="header-anchor" href="#create-private-key-and-self-signed-ca-certificate" aria-hidden="true">#</a> Create private key and self-signed CA certificate</h3><pre><code>**First create the CA&#39;s private key**
...
</code></pre>`,21),x={id:"enterprise-solutions",tabindex:"-1"},$=e("a",{class:"header-anchor",href:"#enterprise-solutions","aria-hidden":"true"},"#",-1),C=e("h3",{id:"graylog",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#graylog","aria-hidden":"true"},"#"),t(" Graylog")],-1),N=e("p",null,"Graylog is a leading centralized log management solution built to open standards for capturing, storing, and enabling real-time analysis of terabytes of machine data.",-1),E={href:"https://www.graylog.org/products/enterprise",target:"_blank",rel:"noopener noreferrer"};function q(G,D){const n=r("ExternalLinkIcon"),o=r("Badge");return l(),c("div",null,[p,u,e("p",null,[e("a",g,[t("Graylog website"),a(n)]),t(),e("a",h,[t("GitHub"),a(n)])]),m,y,e("p",null,[e("a",f,[v,a(n)])]),b,e("p",null,[t("Download the latest plugin release: "),e("a",k,[t("Graylog2/graylog-plugin-cef"),a(n)]),t(".")]),w,e("p",null,[t("Reference: "),e("a",_,[t("Encrypting Syslog Traffic with TLS (SSL)"),a(n)])]),S,e("h2",x,[$,t(" Enterprise solutions "),a(o,{text:"non-sponsored",type:"tip"})]),C,N,e("p",null,[e("a",E,[t("Graylog Enterprise"),a(n)])])])}const T=i(d,[["render",q],["__file","index.html.vue"]]);export{T as default};
