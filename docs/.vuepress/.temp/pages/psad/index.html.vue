<template><div><h1 id="psad-intrusion-detection-with-log-analysis" tabindex="-1"><a class="header-anchor" href="#psad-intrusion-detection-with-log-analysis"><span>PSAD Intrusion Detection with Log Analysis <Badge text="Rev 2" type="tip"/></span></a></h1>
...
<h2 id="install-psad-from-source" tabindex="-1"><a class="header-anchor" href="#install-psad-from-source"><span>Install PSAD from source</span></a></h2>
...
<CodeGroup>
<CodeGroupItem title="Ubuntu">
<div class="language-shell-session" data-ext="shell-session" data-title="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">[+] psad alerts will be sent to:
...
<CodeGroup>
<CodeGroupItem title="Ubuntu">
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code>$ <span class="token function">sudo</span> <span class="token function">nano</span> /etc/psad/psad.conf
...
<CodeGroupItem title="Rocky">
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code>server@rocky:~$
...
<h3 id="enable-psad-rules-in-ossec" tabindex="-1"><a class="header-anchor" href="#enable-psad-rules-in-ossec"><span>Enable PSAD rules in OSSEC</span></a></h3>
...
<CodeGroup>
<CodeGroupItem title="Ubuntu">
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token comment"># custom psad logging directives</span>
