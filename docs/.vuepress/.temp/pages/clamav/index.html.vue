<template><div><h1 id="clamav-antivirus-server" tabindex="-1"><a class="header-anchor" href="#clamav-antivirus-server" aria-hidden="true">#</a> ClamAV Antivirus Server <Badge text="Rev 5" type="tip"/></h1>
...
<div class="language-text" data-ext="text"><pre v-pre class="language-text"><code>build-essential make pkg-config python3 python3-pip python3-pytest valgrind
...
<div class="language-text" data-ext="text"><pre v-pre class="language-text"><code>gcc cmake make pkg-config python3 python3-pip python3-pytest valgrind
...
<div class="language-text" data-ext="text"><pre v-pre class="language-text"><code>gcc gcc-c++ cmake make python3 python3-pip valgrind
...
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo yum -y install epel-release &amp;&amp; \
...
<CodeGroupItem title="Rocky">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo yum -y install gcc gcc-c++ cmake make python3 python3-pip valgrind \
bzip2-devel check-devel libcurl-devel libxml2-devel \
ncurses-devel openssl-devel pcre2-devel sendmail-devel zlib-devel json-c-devel
</span></code></pre></div></CodeGroupItem>
</CodeGroup>
...
<CodeGroup>
<CodeGroupItem title="Debian">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">wget http://ftp.se.debian.org/debian/pool/main/j/json-c/libjson-c5_0.15-2_amd64.deb &amp;&amp; \
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo groupadd clamav &amp;&amp; sudo useradd -g clamav -s /bin/false -c "Clam Antivirus" clamav
</span></code></pre></div></CodeGroupItem>
<CodeGroupItem title="1.0.0-rc">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo groupadd clamav &amp;&amp; sudo useradd -g clamav -s /bin/false -c "Clam Antivirus" clamav
</span></code></pre></div></CodeGroupItem>
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">touch clamav.asc &amp;&amp; nano clamav.asc
</span></code></pre></div></CodeGroupItem>
<CodeGroupItem title="1.0.0-rc">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">touch clamav.asc &amp;&amp; nano clamav.asc
</span></code></pre></div></CodeGroupItem>
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">gpg --import clamav.asc
</span></code></pre></div></CodeGroupItem>
<CodeGroupItem title="1.0.0-rc">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">gpg --import clamav.asc
</span></code></pre></div></CodeGroupItem>
...
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">gpg: key 609B024F2B3EDD07: public key "Talos (Talos, Cisco Systems Inc.) &lt;research@sourcefire.com>" imported
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">gpg --edit-key CCE0DFD21EC1A9BF
</span></code></pre></div></CodeGroupItem>
<CodeGroupItem title="Ubuntu">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">gpg --edit-key 609B024F2B3EDD07
</span></code></pre></div></CodeGroupItem>
<CodeGroupItem title="Debian">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">gpg --edit-key 609B024F2B3EDD07
</span></code></pre></div></CodeGroupItem>
...
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">gpg (GnuPG) 2.2.19; Copyright (C) 2019 Free Software Foundation, Inc.
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">wget https://www.clamav.net/downloads/production/clamav-1.2.0.tar.gz &amp;&amp; \
...
<CodeGroupItem title="1.0.0-rc">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">wget https://www.clamav.net/downloads/production/clamav-1.0.0-rc.tar.gz &amp;&amp; \
...
<CodeGroupItem title="Ubuntu">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">wget https://www.clamav.net/downloads/production/clamav-0.105.0.tar.gz &amp;&amp; \
...
<CodeGroupItem title="Debian">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">wget https://www.clamav.net/downloads/production/clamav-0.104.1.tar.gz &amp;&amp; \
...
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">gpg: Signature made Wed 01 Sep 2021 05:52:12 PM UTC
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">tar -xvzf clamav-1.2.0.tar.gz &amp;&amp; \
cd clamav-1.2.0/ &amp;&amp; \
...
<CodeGroupItem title="1.0.0-rc">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">tar -xvzf clamav-1.0.0-rc.tar.gz &amp;&amp; \
cd clamav-1.0.0-rc/ &amp;&amp; \
mkdir -p build &amp;&amp; cd build &amp;&amp; \
cmake .. \
  -D CMAKE_INSTALL_PREFIX=/usr \
...
<CodeGroupItem title="Ubuntu">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">tar -xvzf clamav-0.105.0.tar.gz &amp;&amp; \
cd clamav-0.105.0/ &amp;&amp; \
mkdir -p build &amp;&amp; cd build &amp;&amp; \
cmake .. \
  -D CMAKE_INSTALL_PREFIX=/usr \
...
<CodeGroupItem title="Debian">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">tar -xvzf clamav-0.104.1.tar.gz &amp;&amp; \
cd clamav-0.104.1/ &amp;&amp; \
mkdir -p build &amp;&amp; cd build &amp;&amp; \
cmake .. \
  -D CMAKE_INSTALL_PREFIX=/usr \
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">Test project ~/clamav-1.2.0/build
      Start  1: libclamav
...
<CodeGroupItem title="1.0.0-rc">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">Test project ~/clamav-1.0.0-rc/build
      Start  1: libclamav
...
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">Test project ~/clamav-0.105.0/build
      Start  1: libclamav
...
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">Test project ~/clamav-0.104.1/build
      Start  1: libclamav
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo cmake --build . --target install
</span></code></pre></div></CodeGroupItem>
<CodeGroupItem title="1.0.0-rc">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo cmake --build . --target install
</span></code></pre></div></CodeGroupItem>
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo bash -c 'cat &lt;&lt; EOF > /etc/clamav/clamd.conf
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo bash -c 'cat &lt;&lt; EOF > /etc/clamav/freshclam.conf
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo mkdir /var/log/clamav/ /var/lib/clamav /var/run/clamav/ &amp;&amp; \
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo bash -c 'cat &lt;&lt; EOF > /etc/systemd/system/clamav-freshclam.service
[Unit]
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo bash -c 'cat &lt;&lt; EOF > /etc/systemd/system/clamav-daemon.service
[Unit]
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo systemctl enable clamav-freshclam.service
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo systemctl start clamav-freshclam.service
...
<CodeGroup>
<CodeGroupItem title="Ubuntu">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">netstat -lnp | grep -E "(clam|3310)"
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment">#Automatically Generated by clamav-daemon postinst</span>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># Check for new database 24 times a day</span>
...
<div class="language-powershell" data-ext="powershell"><pre v-pre class="language-powershell"><code>client@windows:~<span class="token function">PS</span>$ <span class="token function">copy</span> <span class="token punctuation">.</span>\conf_examples\clamd<span class="token punctuation">.</span>conf<span class="token punctuation">.</span>sample <span class="token punctuation">.</span>\clamd<span class="token punctuation">.</span>conf
...
<CodeGroup>
<CodeGroupItem title="Windows">
<div class="language-powershell" data-ext="powershell"><pre v-pre class="language-powershell"><code>client@windows:~<span class="token function">PS</span>$ <span class="token punctuation">.</span>\clamdscan<span class="token punctuation">.</span>exe  <span class="token operator">--</span>multiscan <span class="token operator">--</span>quiet <span class="token operator">--</span>file-list= <span class="token operator">--</span>log=
</code></pre></div></CodeGroupItem>
</CodeGroup>
