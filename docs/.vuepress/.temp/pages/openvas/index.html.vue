<template><div><h1 id="greenbone-vulnerability-manager" tabindex="-1"><a class="header-anchor" href="#greenbone-vulnerability-manager" aria-hidden="true">#</a> Greenbone Vulnerability Manager <Badge text="Rev 12" type="tip"/></h1>
...
<h2 id="install-gvm-22-4-x-from-source" tabindex="-1"><a class="header-anchor" href="#install-gvm-22-4-x-from-source" aria-hidden="true">#</a> Install GVM 22.4.x from source</h2>
<p>Begin to install the dependencies for GVM 22.4.x.</p>
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo apt-get update &amp;&amp; \
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo useradd -r -M -U -G sudo -s /usr/sbin/nologin gvm &amp;&amp; \
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">export PATH=$PATH:/usr/local/sbin &amp;&amp; export INSTALL_PREFIX=/usr/local &amp;&amp; \
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">curl -f -L https://www.greenbone.net/GBCommunitySigningKey.asc -o /tmp/GBCommunitySigningKey.asc &amp;&amp; \
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">echo "8AE4BE429B60A59B311C2E739823FAA60ED1E580:6:" > /tmp/ownertrust.txt &amp;&amp; \
...
<h3 id="build-gvm-libraries" tabindex="-1"><a class="header-anchor" href="#build-gvm-libraries" aria-hidden="true">#</a> Build GVM libraries</h3>
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">export GVM_LIBS_VERSION=22.7.1 &amp;&amp; \
...
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">gpg: Signature made Tue 03 Aug 2021 12:11:44 PM UTC
...
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">curl -f -L https://github.com/eclipse/paho.mqtt.c/archive/refs/tags/v1.3.10.tar.gz -o $SOURCE_DIR/paho-client-1.3.10.tar.gz &amp;&amp; \
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">tar -C $SOURCE_DIR -xvzf $SOURCE_DIR/gvm-libs-$GVM_LIBS_VERSION.tar.gz &amp;&amp; \
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">export GVMD_VERSION=22.9.0 &amp;&amp; \
...
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">gpg: Signature made Tue 03 Aug 2021 02:28:53 PM UTC
gpg:                using RSA key 8AE4BE429B60A59B311C2E739823FAA60ED1E580
gpg: Good signature from "Greenbone Community Feed integrity key" [ultimate]
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">tar -C $SOURCE_DIR -xvzf $SOURCE_DIR/gvmd-$GVMD_VERSION.tar.gz &amp;&amp; \
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">export PG_GVM_VERSION=22.6.1 &amp;&amp; \
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">tar -C $SOURCE_DIR -xvzf $SOURCE_DIR/pg-gvm-$PG_GVM_VERSION.tar.gz &amp;&amp; \
...
<h3 id="install-nodejs-and-yarn" tabindex="-1"><a class="header-anchor" href="#install-nodejs-and-yarn" aria-hidden="true">#</a> Install NodeJS and yarn</h3>
<p>Install NodeJS.</p>
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">export NODE_VERSION=node_16.x &amp;&amp; \
...
<CodeGroupItem title="Kali 2023.3">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo apt install -y nodejs
</span></code></pre></div></CodeGroupItem>
</CodeGroup>
<p>Once installed NodeJS proceed to install yarn.</p>
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">curl -sS https://dl.yarnpkg.com/debian/pubkey.gpg | sudo apt-key add - &amp;&amp; \
echo "deb https://dl.yarnpkg.com/debian/ stable main" | sudo tee /etc/apt/sources.list.d/yarn.list &amp;&amp; \
sudo apt update &amp;&amp; \
sudo apt install -y yarn
</span></code></pre></div></CodeGroupItem>
<CodeGroupItem title="Kali 2023.3">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo apt install -y yarn
</span></code></pre></div></CodeGroupItem>
</CodeGroup>
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">export GSA_VERSION=22.7.1 &amp;&amp; \
...
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">gpg: Signature made Tue 03 Aug 2021 02:59:15 PM UTC
gpg:                using RSA key 8AE4BE429B60A59B311C2E739823FAA60ED1E580
gpg: Good signature from "Greenbone Community Feed integrity key" [ultimate]
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">tar -C $SOURCE_DIR -xvzf $SOURCE_DIR/gsa-$GSA_VERSION.tar.gz &amp;&amp; \
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">export GSAD_VERSION=22.6.0 &amp;&amp; \
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">tar -C $SOURCE_DIR -xvzf $SOURCE_DIR/gsad-$GSAD_VERSION.tar.gz &amp;&amp; \
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">export OPENVAS_SMB_VERSION=22.5.3 &amp;&amp; \
...
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">gpg: Signature made Fri 25 Jun 2021 06:36:43 AM UTC
gpg:                using RSA key 8AE4BE429B60A59B311C2E739823FAA60ED1E580
gpg: Good signature from "Greenbone Community Feed integrity key" [ultimate]
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">tar -C $SOURCE_DIR -xvzf $SOURCE_DIR/openvas-smb-$OPENVAS_SMB_VERSION.tar.gz &amp;&amp; \
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">export OPENVAS_SCANNER_VERSION=22.7.5 &amp;&amp; \
...
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">gpg: Signature made Tue 03 Aug 2021 12:59:52 PM UTC
gpg:                using RSA key 8AE4BE429B60A59B311C2E739823FAA60ED1E580
gpg: Good signature from "Greenbone Community Feed integrity key" [ultimate]
</span></code></pre><div class="highlight-lines"><br><br><div class="highlight-line">&nbsp;</div></div></div><CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">tar -C $SOURCE_DIR -xvzf $SOURCE_DIR/openvas-scanner-$OPENVAS_SCANNER_VERSION.tar.gz &amp;&amp; \
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">export OSPD_OPENVAS_VERSION=22.6.0 &amp;&amp; \
...
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">gpg: Signature made Wed 04 Aug 2021 07:13:45 AM UTC
gpg:                using RSA key 8AE4BE429B60A59B311C2E739823FAA60ED1E580
gpg: Good signature from "Greenbone Community Feed integrity key" [ultimate]
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">tar -C $SOURCE_DIR -xvzf $SOURCE_DIR/ospd-openvas-$OSPD_OPENVAS_VERSION.tar.gz &amp;&amp; \
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">export NOTUS_VERSION=22.6.0 &amp;&amp; \
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">tar -C $SOURCE_DIR -xvzf $SOURCE_DIR/notus-scanner-$NOTUS_VERSION.tar.gz &amp;&amp; \
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">mkdir -p $INSTALL_DIR/gvm-tools &amp;&amp; \
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo systemctl start mosquitto.service &amp;&amp; \
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo cp $SOURCE_DIR/openvas-scanner-$OPENVAS_SCANNER_VERSION/config/redis-openvas.conf /etc/redis/ &amp;&amp; \
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo usermod -aG redis gvm
</span></code></pre></div></CodeGroupItem>
<CodeGroupItem title="Kali 2023.3">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo usermod -aG redis _gvm
</span></code></pre></div></CodeGroupItem>
</CodeGroup>
<p>Start the redis server and enable it as a start up service.</p>
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo systemctl start redis-server@openvas.service &amp;&amp; \
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo mkdir -p /var/lib/notus &amp;&amp; \
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo chown gvm:gvm /usr/local/sbin/gvmd &amp;&amp; \
sudo chmod 6750 /usr/local/sbin/gvmd
</span></code></pre></div></CodeGroupItem>
<CodeGroupItem title="Kali 2023.3">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo chown _gvm:_gvm /usr/local/sbin/gvmd &amp;&amp; \
sudo chmod 6750 /usr/local/sbin/gvmd
</span></code></pre></div></CodeGroupItem>
</CodeGroup>
<p>Feed validation.</p>
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">export GNUPGHOME=/tmp/openvas-gnupg &amp;&amp; \
mkdir -p $GNUPGHOME &amp;&amp; \
gpg --import /tmp/GBCommunitySigningKey.asc &amp;&amp; \
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo visudo
</span></code></pre></div></CodeGroupItem>
<CodeGroupItem title="Kali 2023.3">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo visudo
</span></code></pre></div></CodeGroupItem>
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># Allow members of group sudo to execute any command</span>
...
<h3 id="configure-postgresql-database" tabindex="-1"><a class="header-anchor" href="#configure-postgresql-database" aria-hidden="true">#</a> Configure PostgreSQL database</h3>
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo systemctl start postgresql@14-main.service
</span></code></pre></div></CodeGroupItem>
<CodeGroupItem title="Kali 2023.3">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo systemctl start postgresql@15-main.service
</span></code></pre></div></CodeGroupItem>
</CodeGroup>
<p>Proceed to create a Postgres user and database.</p>
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo -u postgres bash
cd
createuser -DRS gvm
createdb -O gvm gvmd
psql gvmd
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-plsql" data-ext="plsql"><pre v-pre class="language-plsql"><code>gvmd<span class="token operator">=</span># <span class="token keyword">create</span> role dba <span class="token keyword">with</span> superuser noinherit<span class="token punctuation">;</span>
...
<h3 id="create-gvm-admin" tabindex="-1"><a class="header-anchor" href="#create-gvm-admin" aria-hidden="true">#</a> Create GVM admin</h3>
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo ldconfig
</span></code></pre></div></CodeGroupItem>
<CodeGroupItem title="Kali 2023.3">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo ldconfig
</span></code></pre></div></CodeGroupItem>
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">/usr/local/sbin/gvmd --create-user=admin --password=admin
User created.
</span></code></pre></div></CodeGroupItem>
<CodeGroupItem title="Kali 2023.3">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo gvmd --create-user=admin --password=admin
User created.
</span></code></pre></div></CodeGroupItem>
</CodeGroup>
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">/usr/local/sbin/gvmd --get-users --verbose
...
<CodeGroupItem title="Kali 2023.3">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo gvmd --get-users --verbose
admin 0279ba6c-391a-472f-8cbd-1f6eb808823b
</span></code></pre></div></CodeGroupItem>
</CodeGroup>
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">/usr/local/sbin/gvmd --modify-setting 78eceaec-3385-11ea-b237-28d24461215b --value UUID_HERE
</span></code></pre></div></CodeGroupItem>
<CodeGroupItem title="Kali 2023.3">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo gvmd --modify-setting 78eceaec-3385-11ea-b237-28d24461215b --value UUID_HERE
</span></code></pre></div></CodeGroupItem>
</CodeGroup>
<h3 id="install-greenbone-feed-sync" tabindex="-1"><a class="header-anchor" href="#install-greenbone-feed-sync" aria-hidden="true">#</a> Install greenbone-feed-sync</h3>
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">mkdir -p $INSTALL_DIR/greenbone-feed-sync &amp;&amp; \
...
<h3 id="greenbone-feed-synchronisation" tabindex="-1"><a class="header-anchor" href="#greenbone-feed-synchronisation" aria-hidden="true">#</a> Greenbone Feed synchronisation</h3>
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo /usr/local/bin/greenbone-feed-sync
</span></code></pre></div></CodeGroupItem>
<CodeGroupItem title="Kali 2023.3">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo /usr/local/bin/greenbone-feed-sync
</span></code></pre></div></CodeGroupItem>
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">cat &lt;&lt; EOF > $BUILD_DIR/ospd-openvas.service
[Unit]
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo cp $BUILD_DIR/ospd-openvas.service /etc/systemd/system/
</span></code></pre></div></CodeGroupItem>
<CodeGroupItem title="Kali 2023.3">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo cp $BUILD_DIR/ospd-openvas.service /etc/systemd/system/
</span></code></pre></div></CodeGroupItem>
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">cat &lt;&lt; EOF > $BUILD_DIR/notus-scanner.service
[Unit]
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo cp $BUILD_DIR/notus-scanner.service /etc/systemd/system/
</span></code></pre></div></CodeGroupItem>
<CodeGroupItem title="Kali 2023.3">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo cp $BUILD_DIR/notus-scanner.service /etc/systemd/system/
</span></code></pre></div></CodeGroupItem>
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">cat &lt;&lt; EOF > $BUILD_DIR/gvmd.service
[Unit]
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo cp $BUILD_DIR/gvmd.service /etc/systemd/system/
</span></code></pre></div></CodeGroupItem>
<CodeGroupItem title="Kali 2023.3">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo cp $BUILD_DIR/gvmd.service /etc/systemd/system/
</span></code></pre></div></CodeGroupItem>
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">cat &lt;&lt; EOF > $BUILD_DIR/gsad.service
[Unit]
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo cp $BUILD_DIR/gsad.service /etc/systemd/system/
</span></code></pre></div></CodeGroupItem>
<CodeGroupItem title="Kali 2023.3">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo cp $BUILD_DIR/gsad.service /etc/systemd/system/
</span></code></pre></div></CodeGroupItem>
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo systemctl daemon-reload
</span></code></pre></div></CodeGroupItem>
<CodeGroupItem title="Kali 2023.3">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo systemctl daemon-reload
</span></code></pre></div></CodeGroupItem>
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo systemctl enable notus-scanner
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo systemctl start ospd-openvas
...
<CodeGroup>
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo systemctl status ospd-openvas.service
</span></code></pre></div></CodeGroupItem>
<CodeGroupItem title="Kali 2023.3">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo systemctl status ospd-openvas.service
</span></code></pre></div></CodeGroupItem>
</CodeGroup>
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">● ospd-openvas.service - OSPd Wrapper for the OpenVAS Scanner (ospd-openvas)
...
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo systemctl status gvmd.service
</span></code></pre></div></CodeGroupItem>
<CodeGroupItem title="Kali 2023.3">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo systemctl status gvmd.service
</span></code></pre></div></CodeGroupItem>
...
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">● gvmd.service - Greenbone Vulnerability Manager daemon (gvmd)
...
<CodeGroupItem title="Ubuntu 22.04">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo systemctl status gsad.service
</span></code></pre></div></CodeGroupItem>
<CodeGroupItem title="Kali 2023.3">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">sudo systemctl status gsad.service
</span></code></pre></div></CodeGroupItem>
</CodeGroup>
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">● gsad.service - Greenbone Security Assistant daemon (gsad)
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># This file controls the state of SELinux on the system.</span>
...
<CodeGroup>
<CodeGroupItem title="Rocky">
<div class="language-shell-session" data-ext="shell-session"><pre v-pre class="language-shell-session"><code><span class="token output">Updating OpenVAS Manager certificates: Complete
