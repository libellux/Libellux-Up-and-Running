<template><h1 id="rsyslog-syslog-processing" tabindex="-1"><a class="header-anchor" href="#rsyslog-syslog-processing" aria-hidden="true">#</a> Rsyslog Syslog Processing</h1>
...
<p>To generate a syslog message on client simply type from cli <code>$ logger test</code></p>
...
<p>The script creates a self-signed certificate authority and signs your generated certificate(s). Browse the <code>certs/</code> folder and copy the new client folder to your remote machine.</p>
