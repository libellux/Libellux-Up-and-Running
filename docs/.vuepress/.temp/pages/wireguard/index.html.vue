<template><div><h1 id="wireguard-secure-vpn-tunnel" tabindex="-1"><a class="header-anchor" href="#wireguard-secure-vpn-tunnel"><span>WireGuard Secure VPN Tunnel <Badge text="Rev 2" type="tip"/></span></a></h1>
...
<h2 id="master-server" tabindex="-1"><a class="header-anchor" href="#master-server"><span>Master server</span></a></h2>
...
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>Interface<span class="token punctuation">]</span>
...
<h2 id="client-servers" tabindex="-1"><a class="header-anchor" href="#client-servers"><span>Client servers</span></a></h2>
...
<div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre v-pre class="language-text"><code>client@ubuntu:~$ ping 192.168.8.1
...
<div class="language-console line-numbers-mode" data-ext="console" data-title="console"><pre v-pre class="language-console"><code>server@ubuntu:~$ sudo ufw allow proto udp from 192.168.8.0/32 to any port 51820 comment &quot;WireGuard&quot;
client@ubuntu:~§ sudo ufw allow proto udp from 192.168.8.1 to any port 51820 comment &quot;WireGuard server&quot;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="troubleshooting" tabindex="-1"><a class="header-anchor" href="#troubleshooting"><span>Troubleshooting</span></a></h2>
...
<h2 id="recommended-services" tabindex="-1"><a class="header-anchor" href="#recommended-services"><span>Recommended services</span></a></h2>
<h3 id="mullvad-vpn" tabindex="-1"><a class="header-anchor" href="#mullvad-vpn"><span>Mullvad VPN <Badge text="non-affiliate" type="tip"/></span></a></h3>
