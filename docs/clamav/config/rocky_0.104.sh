...
# Description: Pre-installation test for ClamAV 0.104 on Rocky 8 (Green Obsidian)
...
# Verify
wget https://www.clamav.net/downloads/production/clamav-0.104.0.tar.gz && \
...
# Build
tar -xvzf clamav-0.104.0.tar.gz && \
cd clamav-0.104.0/ && \
